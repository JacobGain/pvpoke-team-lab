...
const requiredSeoFragments = [
  ...
  'rel="icon"',
  'type="image/png" sizes="48x48" href="/favicon-48x48.png?v=1.0.4"',
  'type="image/png" sizes="96x96" href="/favicon-96x96.png?v=1.0.4"',
  'type="image/x-icon" sizes="any" href="/favicon.ico?v=1.0.4"',
];
